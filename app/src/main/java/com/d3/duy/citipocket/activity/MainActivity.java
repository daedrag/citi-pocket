...
//                Snackbar.make(MainActivity.this.toolbar, "Permission READ SMS granted", Snackbar.LENGTH_SHORT).show();
    ...
    private class LoadMessageTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            MessageStore.getInstance(getContentResolver()).load(true);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            List<MessageEnrichmentHolder> messages = MessageStore.getInstance().getEnrichedMessages();
        ...
        protected Void doInBackground(Void... params) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    fragmentAccount.initAdapter();
                    fragmentAccount.reloadAdapter();
